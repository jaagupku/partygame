...
const en = defineMessages({
	...
	auth: {
		...
		loginSubtitle: 'Log in to create and manage your game definitions.',
		signupSubtitle: 'Create an account to save your own definitions.',
	...
	definitions: {
		...
		cannotEditDefinition: 'You do not have permission to edit this definition.',
		definitionSaved: 'Definition saved.',
		couldNotSaveDefinition: 'Could not save definition.',
		definitionExported: 'Definition exported.',
		couldNotExportDefinition: 'Could not export definition.',
		saveBeforeExport: 'Save this definition before exporting it.',
		definitionImported: 'Definition imported.',
		couldNotImportDefinition: 'Could not import definition.',
		deleteDefinition: 'Delete Definition',
		definitionDeleted: 'Definition deleted.',
		couldNotDeleteDefinition: 'Could not delete definition.',
		deleteDefinitionMessage: 'This definition will be permanently deleted.',
		visibility: 'Visibility',
		visibilityPublic: 'Public',
		visibilityLoginRequired: 'Login required',
		visibilityPrivate: 'Private',
		owner: 'Owner',
		signInToCreate: 'Log in to create and edit definitions.',
	...
	editor: {
		...
		autoplayVideoHelp: 'Start the video automatically when the step opens.',
...
const et: Messages = {
	...
	auth: {
		...
		loginSubtitle: 'Logi sisse, et mängudefinitsioone luua ja hallata.',
		signupSubtitle: 'Loo konto, et oma definitsioone salvestada.',
	...
	definitions: {
		...
		cannotEditDefinition: 'Sul pole õigust seda definitsiooni muuta.',
		definitionSaved: 'Definitsioon salvestatud.',
		couldNotSaveDefinition: 'Definitsiooni ei saanud salvestada.',
		definitionExported: 'Definitsioon eksporditud.',
		couldNotExportDefinition: 'Definitsiooni ei saanud eksportida.',
		saveBeforeExport: 'Salvesta definitsioon enne eksportimist.',
		definitionImported: 'Definitsioon imporditud.',
		couldNotImportDefinition: 'Definitsiooni ei saanud importida.',
		deleteDefinition: 'Kustuta definitsioon',
		definitionDeleted: 'Definitsioon kustutatud.',
		couldNotDeleteDefinition: 'Definitsiooni ei saanud kustutada.',
		deleteDefinitionMessage: 'See definitsioon kustutatakse jäädavalt.',
		visibility: 'Nähtavus',
		visibilityPublic: 'Avalik',
		visibilityLoginRequired: 'Sisselogimine nõutud',
		visibilityPrivate: 'Privaatne',
		owner: 'Omanik',
		signInToCreate: 'Logi sisse, et definitsioone luua ja muuta.',
	...
	editor: {
		...
		autoplayVideoHelp: 'Alusta videot automaatselt, kui samm avaneb.',
